...
class Container_890b20cc32 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_890b20cc32 $container)
			{
	...
	public function createServiceContainer(): Container_890b20cc32
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'paths' => [
				...
				'/Users/junlonglin/Herd/CrediBiz/routes',
			],
			'exceptions' => [
				'implicitThrows' => true,
